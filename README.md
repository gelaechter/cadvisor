...
# This fork allows skipping version validation for the use of custom docker engines

**Add the flag `--docker-ignore-version` to the start and the version validation is skipped. cAdvisor is given the arbitrary version number "20.10.17", use at your own risk.**
